...
- Nguồn nạp data tự động SFTP / API real-time + validate 2 bước — FR-001 / FR-003
...
> "Thời gian cho phép gọi" (Cả ngày / Khung giờ) giữ nguyên tính năng OMICRM — ngoài phạm vi nâng cấp.
